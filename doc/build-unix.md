UNIX BUILD NOTES
====================
Some notes on how to build Infinitecoin Core in Unix.
...
memory available when compiling Infinitecoin Core. On systems with less, gcc can be
...
See the section "Disable-wallet mode" to build Infinitecoin Core without wallet.
...
As mentioned above, when maintaining portability of the wallet between the standard Infinitecoin Core distributions and independently built
...
with 4.8-built Infinitecoin Core is needed follow the steps under "Berkeley DB" above.
